...
public class CustomShell {
    ...
    public void updateBook(
        ...
        bookService.save(BookDto.builder().id(Long.parseLong(id)).title(title).genre(genre).firstname(firstname).lastname(lastname).build());
    }
    ...
    public void updateComment(
        ...
        commentService.save(CommentDto.builder().id(Long.parseLong(id)).text(text).bookTitle(bookTitle).build());
    }
