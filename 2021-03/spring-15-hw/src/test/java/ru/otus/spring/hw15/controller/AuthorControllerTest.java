...
import ru.otus.spring.hw15.config.ControllerConfigTest;
import ru.otus.spring.hw15.data.AuthorDtoDataBuilder;
...
class AuthorControllerTest {
    public static final String FIRSTNAME = "Александр";
    public static final String LASTNAME = "Пушкин";
    @Autowired
    private MockMvc mvc;
    @Autowired
