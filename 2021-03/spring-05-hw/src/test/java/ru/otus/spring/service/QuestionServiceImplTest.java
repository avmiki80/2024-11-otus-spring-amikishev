...
import ru.otus.spring.config.BaseServiceConfigTest;
...
@ContextConfiguration(classes = QuestionServiceImplTest.QuestionServiceServiceConfig.class)
...
class QuestionServiceImplTest {
    ...
    public void whenGetQuestion_thenThrowsException(){
        CustomServiceException exception = assertThrows(CustomServiceException.class, () -> questionService.get("q4"));
        assertThat(exception.getMessage()).isEqualTo("Вопрос не найден");
    }
    ...
    public void whenDeleteQuestion_thenThrowsException(){
        CustomServiceException exception = assertThrows(CustomServiceException.class, () -> questionService.remove(new Question("q4", "a4")));
        assertThat(exception.getMessage()).isEqualTo("Вопрос не найден");
    }
    ...
    @TestConfiguration
    static class QuestionServiceServiceConfig extends BaseServiceConfigTest {
        @MockBean
        private ResourceLoader<Question> resourceLoader;
        @Bean
        ...
        public QuestionService questionService(){
            return new QuestionServiceImpl(questionDao(), customMessageService());
        }
    }
}