...
@TestConfiguration
public class ServiceServiceConfigTest extends BaseServiceConfigTest {
    ...
    public ExaminatorService examinatorService(){
        return new ExaminatorServiceImpl(testingService(), rateService(), readWriteService, customMessageService());
    }
    @Bean
    public RateService rateService(){
        return new RateServiceImpl(thresholdCorrectAnswer, customMessageService());
    }
    @Bean
    public RateService wrongRateService(){
        return new RateServiceImpl(null, customMessageService());
    }
}
