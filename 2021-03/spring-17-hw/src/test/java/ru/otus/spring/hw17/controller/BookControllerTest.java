...
import ru.otus.spring.hw17.config.ControllerConfigTest;
import ru.otus.spring.hw17.data.BookDTODataBuilder;
...
class BookControllerTest {
    ...
    void whenUpdateWithWrongRole_thenReturnStatusForbidden() throws Exception {
        ...
        String forSave = mapper.writeValueAsString(book);
        mvc.perform(put("/book/{id}", 1).contentType(APPLICATION_JSON)
                        .content(forSave))
                .andExpect(status().isForbidden());
    }
